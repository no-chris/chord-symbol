(function webpackUniversalModuleDefinition(root, factory) {
	...
	else if (typeof exports === 'object') exports['chord-symbol'] = factory();
...
*/
								...
								if (
									...
									if (
										...
										return {
											...
											value: uncurriedNativeRegExpMethod(
												regexp,
												str,
												arg2
											),
				...
				var enable = function () {
					...
					if (getOwnPropertyNames(test).length) {
						...
						$(
							...
							{
								getOwnPropertyNames:
									getOwnPropertyNamesExternalModule.f,
							}
						);
					}
				};
						...
						return [
							...
							function (string, replaceValue) {
								...
								for (var i = 0; i < results.length; i++) {
									...
									var position = max(
										min(
											toIntegerOrInfinity(result.index),
											S.length
										),
										0
									);
								...
								return (
									accumulatedResult +
									stringSlice(S, nextSourcePosition)
								);
							},
						];
					},
						...
						if (
							...
							internalSplit = function (separator, limit) {
								...
								if (lastLastIndex === string.length) {
									...
									push(
										output,
										stringSlice(string, lastLastIndex)
									);
					...
					if (DOMIterables[COLLECTION_NAME]) {
						handlePrototype(
							global[COLLECTION_NAME] &&
								global[COLLECTION_NAME].prototype
						);
					}
				}
			...
			/***/ 4626: /***/ (module, exports, __webpack_require__) => {
		...
		(() => {
			...
			__webpack_require__.d(__webpack_exports__, {
				chordParserFactory: () =>
					/* reexport */ parser_chordParserFactory,
				chordRendererFactory: () =>
					/* reexport */ renderer_chordRendererFactory,
			});
			...
			var es_regexp_exec = __webpack_require__(4916); // CONCATENATED MODULE: ./src/helpers/chain.js
			/**
			...
			var cloneDeep_default =
				/*#__PURE__*/ __webpack_require__.n(cloneDeep); // CONCATENATED MODULE: ./src/helpers/checkCustomFilters.js
			var checkCustomFilters = function checkCustomFilters(
				customFilters
			) {
				if (!Array.isArray(customFilters)) {
					throw new TypeError(
						'customFilters should be given as an array'
					);
				}

				if (
					customFilters.some(function (filter) {
			...
			/* harmony default export */ const helpers_checkCustomFilters =
				checkCustomFilters;
			...
			var es_object_get_own_property_descriptors =
				__webpack_require__(9337); // CONCATENATED MODULE: ./src/dictionaries/notes.js
			...
			var englishVariantsToNotes = _objectSpread(
				_objectSpread({}, english),
				getAccidentalsVariation(english)
			);

			var latinVariantsToNotes = _objectSpread(
				_objectSpread({}, latin),
			...
			var allVariantsToNotes = _objectSpread(
				_objectSpread(
					_objectSpread({}, englishVariantsToNotes),
					latinVariantsToNotes
				),
				germanVariantsToNotes
			);

			var allVariants = Object.keys(allVariantsToNotes).sort(function (
				a,
				b
			) {
				return b.length - a.length;
			});
			var englishVariants = Object.keys(englishVariantsToNotes).sort(
				function (a, b) {
					return b.length - a.length;
				}
			);
			var latinVariants = Object.keys(latinVariantsToNotes).sort(
				function (a, b) {
					return b.length - a.length;
				}
			);
			var germanVariants = Object.keys(germanVariantsToNotes).sort(
				function (a, b) {
					return b.length - a.length;
				}
			);
			...
			var es_map = __webpack_require__(1532); // CONCATENATED MODULE: ./src/helpers/ChordParsingError.js
			...
			var NoSymbolFoundError = /*#__PURE__*/ (function (
				_ChordSymbolError
			) {
			...
			var InvalidModifierError = /*#__PURE__*/ (function (
				_ChordSymbolError2
			) {
				...
				function InvalidModifierError(chord, invalidChars) {
					...
					var message = 'The chord descriptor "'
						.concat(
							chord.input.descriptor,
							'" contains unknown or duplicated modifiers: "'
						)
						.concat(invalidChars, '"');
					return _super5.call(
						this,
			...
			var InvalidIntervalsError = /*#__PURE__*/ (function (
				_ChordSymbolError3
			) {
			...
			var isEqual_default = /*#__PURE__*/ __webpack_require__.n(isEqual); // CONCATENATED MODULE: ./src/helpers/hasElement.js
			...
			var allForbiddenCombos = [
				['2', '3'],
				['2', '9'],
				['3', 'b3'], //['3',  '4'], // valid in the Real Book: F#7SUS(add 3)
				['4', '11'],
				['5', 'b5'],
				['5', '#5'],
				['b6', '#5'],
			...
			var es_array_map = __webpack_require__(1249); // CONCATENATED MODULE: ./src/dictionaries/qualities.js
			var qualities = {
				ma: 'major',
				ma6: 'major6',
				ma7: 'major7',
			...
			var qualityToDescriptor =
				...
				formatSymbolParts_defineProperty(
					...
					qualities.ma6,
					function (chord) {
						return chord.normalized.intervals.includes('9')
							? '69'
							: '6';
					}
				),
			...
			function getDescriptor(chord) {
				var descriptor =
					qualityToDescriptor[chord.normalized.quality](chord);
			...
			function getHighestExtension(chord) {
				...
				if (
					...
					highestExtension = hasNoneOf(chord.normalized.alterations, [
						'b9',
						'#9',
					])
						? '9'
			...
			function getChordChanges(chord) {
				...
				var formattedAdds = formatAdds(
					chord.normalized.quality,
					chord.normalized.adds
				);
				return [].concat(
					_toConsumableArray(chord.normalized.alterations),
					_toConsumableArray(formattedAdds),
					_toConsumableArray(formattedOmits)
				);
			}
			...
			function formatAdds(quality, adds) {
				return adds
					...
					.map(function (add, index) {
						...
						formatted +=
							add === '7' ? chordChangesDescriptors.add7 : add;
						return formatted;
					});
			}
			...
			var es_string_starts_with = __webpack_require__(6755); // CONCATENATED MODULE: ./src/parser/filters/getParsableDescriptor.js
			/**
			...
			function toLowerCaseExceptMajorM(descriptor) {
				return descriptor
					.replace(/[A-LN-Za-z]+/g, function (match) {
			...
			function initChord() {
				...
				return {
					...
					formatted: {},
					parserConfiguration:
						cloneDeep_default()(parserConfiguration),
				};
			...
			function nameIndividualChordNotes_toConsumableArray(arr) {
				return (
					nameIndividualChordNotes_arrayWithoutHoles(arr) ||
					nameIndividualChordNotes_iterableToArray(arr) ||
					nameIndividualChordNotes_unsupportedIterableToArray(arr) ||
					nameIndividualChordNotes_nonIterableSpread()
				);
			}
			...
			function nameIndividualChordNotes_unsupportedIterableToArray(
				o,
				minLen
			) {
				if (!o) return;
				if (typeof o === 'string')
					return nameIndividualChordNotes_arrayLikeToArray(o, minLen);
				var n = Object.prototype.toString.call(o).slice(8, -1);
				if (n === 'Object' && o.constructor) n = o.constructor.name;
				if (n === 'Map' || n === 'Set') return Array.from(o);
				if (
			...
			function nameIndividualChordNotes_arrayWithoutHoles(arr) {
				if (Array.isArray(arr))
					return nameIndividualChordNotes_arrayLikeToArray(arr);
			}
			...
			var rootNoteToScaleAccidentals =
				((_rootNoteToScaleAccid = {}),
				nameIndividualChordNotes_defineProperty(
					_rootNoteToScaleAccid,
					notes.C,
					{
						maj: 'flat',
			...
			function nameIndividualChordNotes(chord) {
				...
				var indexedNotes = [].concat(
					nameIndividualChordNotes_toConsumableArray(
			...
			function normalizeNotes(chord) {
				chord.normalized.rootNote =
					allVariantsToNotes[chord.input.rootNote];

				if (chord.input.bassNote) {
					chord.normalized.bassNote =
						allVariantsToNotes[chord.input.bassNote];
				}
			...
			var without_default = /*#__PURE__*/ __webpack_require__.n(without); // CONCATENATED MODULE: ./src/parser/filters/normalizeDescriptor.js
			...
			function normalizeDescriptor_objectSpread(target) {
				for (var i = 1; i < arguments.length; i++) {
					var source = null != arguments[i] ? arguments[i] : {};
					i % 2
						? normalizeDescriptor_ownKeys(
								Object(source),
								!0
						  ).forEach(function (key) {
								normalizeDescriptor_defineProperty(
									target,
									key,
									source[key]
								);
						...
						: normalizeDescriptor_ownKeys(Object(source)).forEach(
								function (key) {
									Object.defineProperty(
										target,
										key,
			...
			function normalizeDescriptor_toConsumableArray(arr) {
				return (
					normalizeDescriptor_arrayWithoutHoles(arr) ||
					normalizeDescriptor_iterableToArray(arr) ||
					normalizeDescriptor_unsupportedIterableToArray(arr) ||
					normalizeDescriptor_nonIterableSpread()
				);
			}
			...
			function normalizeDescriptor_unsupportedIterableToArray(o, minLen) {
				if (!o) return;
				if (typeof o === 'string')
					return normalizeDescriptor_arrayLikeToArray(o, minLen);
				var n = Object.prototype.toString.call(o).slice(8, -1);
				if (n === 'Object' && o.constructor) n = o.constructor.name;
				if (n === 'Map' || n === 'Set') return Array.from(o);
				if (
			...
			function normalizeDescriptor_arrayWithoutHoles(arr) {
				if (Array.isArray(arr))
					return normalizeDescriptor_arrayLikeToArray(arr);
			}
			...
			function normalizeDescriptor(chord) {
				var chordIntervals = clone_default()(
				...
				if (isPowerChord(chordIntervals)) {
					...
					var isSuspended = getIsSuspended(
						chordIntervals,
						chord.normalized.intents.major
					);

					var _getChordQuality = getChordQuality(
							chordIntervals,
							chord,
							isSuspended,
							omits
					...
					var baseIntervals = ['1'].concat(
						normalizeDescriptor_toConsumableArray(qualityIntervals),
						normalizeDescriptor_toConsumableArray(extensions)
					);

					var _getAddsAndAlteration = getAddsAndAlterations(
							chordIntervals,
							baseIntervals,
							quality
						),
					...
					normalized = normalizeDescriptor_objectSpread(
						normalizeDescriptor_objectSpread({}, normalized),
						{},
						{
							quality: quality,
				...
				return normalizeDescriptor_objectSpread(
					normalizeDescriptor_objectSpread({}, chord),
					{},
					{
						normalized: normalizeDescriptor_objectSpread(
							normalizeDescriptor_objectSpread(
								{},
								chord.normalized
							),
							normalized
			...
			function getChordQuality(allIntervals, chord, isSuspended, omits) {
				var intervalsForQualityDetection =
				...
				var intervalsToQualities = [
					...
					return (
						b.qualityIntervals.length - a.qualityIntervals.length
					);
				});
			...
			function getAddsAndAlterations(
				chordIntervals,
				baseIntervals,
				quality
			) {
			...
			var es_regexp_constructor = __webpack_require__(4603); // CONCATENATED MODULE: ./src/parser/filters/parseBase.js
			/**
			...
			function parseBase(noteVariants, chord) {
				...
				var notesAndDescriptorRegex = new RegExp(
					'^' +
						'(' +
						notesRegex +
						')' +
			...
			var es_string_trim = __webpack_require__(3210); // CONCATENATED MODULE: ./src/dictionaries/modifiers.js
			...
			function modifiers_objectSpread(target) {
				for (var i = 1; i < arguments.length; i++) {
					var source = null != arguments[i] ? arguments[i] : {};
					i % 2
						? modifiers_ownKeys(Object(source), !0).forEach(
								function (key) {
									modifiers_defineProperty(
										target,
										key,
										source[key]
									);
						...
						: modifiers_ownKeys(Object(source)).forEach(function (
								key
						  ) {
								Object.defineProperty(
									target,
			...
			var major7th = getDerivedModifiers(
				major,
				allModifiers.add7,
				function (symbol) {
					return symbol + '7';
			...
			var allSymbols = modifiers_objectSpread(
				modifiers_objectSpread(
					modifiers_objectSpread(
						modifiers_objectSpread({}, major),
						major7th
					),
					{},
					{
			...
			var modifiers_allVariants = Object.keys(allSymbols).sort(function (
				a,
				b
			) {
				return b.length - a.length;
			...
			/* harmony default export */ const modifiers = allModifiers; // CONCATENATED MODULE: ./src/dictionaries/intervalsToSemitones.js
			...
			function parseDescriptor_toConsumableArray(arr) {
				return (
					parseDescriptor_arrayWithoutHoles(arr) ||
					parseDescriptor_iterableToArray(arr) ||
					parseDescriptor_unsupportedIterableToArray(arr) ||
					parseDescriptor_nonIterableSpread()
				);
			}
			...
			function parseDescriptor_unsupportedIterableToArray(o, minLen) {
				if (!o) return;
				if (typeof o === 'string')
					return parseDescriptor_arrayLikeToArray(o, minLen);
				var n = Object.prototype.toString.call(o).slice(8, -1);
				if (n === 'Object' && o.constructor) n = o.constructor.name;
				if (n === 'Map' || n === 'Set') return Array.from(o);
				if (
			...
			function parseDescriptor_arrayWithoutHoles(arr) {
				if (Array.isArray(arr))
					return parseDescriptor_arrayLikeToArray(arr);
			}
			...
			function parseDescriptor(altIntervals, chord) {
				...
				chord.normalized.intervals = getIntervals(
					allModifiers,
					altIntervals
				);
				chord.normalized.semitones = getSemitones(
					chord.normalized.intervals
				);
			...
			function getModifiers(chord) {
				...
				var modifiers = [];
				var descriptorRegex = new RegExp(
					modifiers_allVariants.map(escapeRegex).join('|'),
					'g'
				);
				var descriptorMatches =
					parsableDescriptor.match(descriptorRegex);
			...
			function getIntervals(allModifiers, altIntervals) {
				...
				return uniq_default()(
					['1'].concat(
						parseDescriptor_toConsumableArray(
			...
			function getFifths(allModifiers, altIntervals) {
				...
				if (
					!fifths.length &&
					!allModifiers.includes(modifiers.thirteenthFlat)
				) {
					fifths.push('5');
				}
			...
			function getNinths(allModifiers, altIntervals) {
				...
				if (
					...
					hasNoneOf(allModifiers, [
						modifiers.ninthFlat,
						modifiers.ninthSharp,
					])
				) {
					ninth.push('9');
				}
			...
			function shouldAlter(allModifiers, altIntervals, interval) {
				return (
					allModifiers.includes(modifiers.alt) &&
					altIntervals.includes(interval)
				);
			}

			function hasMajorIntent(allModifiers) {
				return hasNoneOf(allModifiers, [
					modifiers.mi,
					modifiers.dim,
					modifiers.dim7,
					modifiers.halfDim,
			...
			function chordParserFactory_toConsumableArray(arr) {
				return (
					chordParserFactory_arrayWithoutHoles(arr) ||
					chordParserFactory_iterableToArray(arr) ||
					chordParserFactory_unsupportedIterableToArray(arr) ||
					chordParserFactory_nonIterableSpread()
				);
			}
			...
			function chordParserFactory_unsupportedIterableToArray(o, minLen) {
				if (!o) return;
				if (typeof o === 'string')
					return chordParserFactory_arrayLikeToArray(o, minLen);
				var n = Object.prototype.toString.call(o).slice(8, -1);
				if (n === 'Object' && o.constructor) n = o.constructor.name;
				if (n === 'Map' || n === 'Set') return Array.from(o);
				if (
			...
			function chordParserFactory_arrayWithoutHoles(arr) {
				if (Array.isArray(arr))
					return chordParserFactory_arrayLikeToArray(arr);
			}
			...
			function chordParserFactory() {
				...
				var _parserConfiguration$ = parserConfiguration.notationSystems,
					notationSystems =
						_parserConfiguration$ === void 0
							? cloneDeep_default()(allNotationSystems)
							: _parserConfiguration$,
					_parserConfiguration$2 = parserConfiguration.altIntervals,
					altIntervals =
						_parserConfiguration$2 === void 0
							? cloneDeep_default()(allAltIntervals)
							: _parserConfiguration$2,
					_parserConfiguration$3 = parserConfiguration.customFilters,
					customFilters =
						_parserConfiguration$3 === void 0
							? []
							: _parserConfiguration$3;
				...
				function parseChord(symbol) {
					...
					var allVariantsPerGroupCopy = cloneDeep_default()(
						allVariantsPerGroup
					).filter(function (variantsGroup) {
					...
					if (!allErrors.length) {
						while (allVariantsPerGroupCopy.length && !chord) {
							...
							allFilters = [
								...
								chordParserFactory_toConsumableArray(
									customFilters
								)
							);
							...
							try {
								...
								if (chord) {
									...
									allErrors.push(
										getUnexpectedError(variants.name)
									);
								}
							} catch (e) {
			...
			function checkArray(
				...
				if (!Array.isArray(arrayToTest)) {
					throw new TypeError(
						"'".concat(arrayName, "' should be an array")
					);
				}

				if (!allowEmpty && arrayToTest.length === 0) {
					throw new TypeError(
						"'".concat(arrayName, "' cannot be empty")
					);
				}
				...
				arrayToTest.forEach(function (system) {
					if (!allowedValues.includes(system)) {
						throw new TypeError(
							"'"
								.concat(system, "' is not a valid value for ")
								.concat(arrayName)
						);
					}
				});
			...
			/* harmony default export */ const parser_chordParserFactory =
				chordParserFactory; // CONCATENATED MODULE: ./src/renderer/filters/shortenNormalized.js
			...
			function shortenNormalized_objectSpread(target) {
				for (var i = 1; i < arguments.length; i++) {
					var source = null != arguments[i] ? arguments[i] : {};
					i % 2
						? shortenNormalized_ownKeys(Object(source), !0).forEach(
								function (key) {
									shortenNormalized_defineProperty(
										target,
										key,
										source[key]
									);
						...
						: shortenNormalized_ownKeys(Object(source)).forEach(
								function (key) {
									Object.defineProperty(
										target,
										key,
			...
			function shortenNormalized(chord) {
				...
				return shortenNormalized_objectSpread(
					shortenNormalized_objectSpread({}, chord),
					{},
					{
						formatted: shortenNormalized_objectSpread(
							shortenNormalized_objectSpread({}, chord.formatted),
							{},
							{
			...
			var difference_default =
				/*#__PURE__*/ __webpack_require__.n(difference); // CONCATENATED MODULE: ./src/renderer/filters/simplify.js
			/**
			 * @param {Chord} chord
			...
			function simplify_simplify() {
				...
				var intervals = difference_default()(
					chord.normalized.intervals,
			...
			var invert_default = /*#__PURE__*/ __webpack_require__.n(invert); // CONCATENATED MODULE: ./src/renderer/filters/transpose.js
			var transpose_notes = [
				'C',
				'C#',
				'D',
			...
			function convertNotationSystem() {
				var notationSystem =
					arguments.length > 0 && arguments[0] !== undefined
						...
						: 'english';
				var chord = arguments.length > 1 ? arguments[1] : undefined;
				var finalNotationSystem =
					notationSystem === 'auto'
						? chord.input.notationSystem
						: notationSystem;
				if (finalNotationSystem === 'english') return chord;
				if (!allNotationSystems.includes(finalNotationSystem))
					return null;
				chord.formatted.rootNote =
					translationTables[finalNotationSystem][
						chord.formatted.rootNote
					];
			...
			function chordRendererFactory_toConsumableArray(arr) {
				return (
					chordRendererFactory_arrayWithoutHoles(arr) ||
					chordRendererFactory_iterableToArray(arr) ||
					chordRendererFactory_unsupportedIterableToArray(arr) ||
					chordRendererFactory_nonIterableSpread()
				);
			}
			...
			function chordRendererFactory_unsupportedIterableToArray(
				o,
				minLen
			) {
				if (!o) return;
				if (typeof o === 'string')
					return chordRendererFactory_arrayLikeToArray(o, minLen);
				var n = Object.prototype.toString.call(o).slice(8, -1);
				if (n === 'Object' && o.constructor) n = o.constructor.name;
				if (n === 'Map' || n === 'Set') return Array.from(o);
				if (
			...
			function chordRendererFactory_arrayWithoutHoles(arr) {
				if (Array.isArray(arr))
					return chordRendererFactory_arrayLikeToArray(arr);
			}
			...
			function chordRendererFactory() {
				var _ref =
					...
					useShortNamings =
						_ref$useShortNamings === void 0
							? false
							: _ref$useShortNamings,
					_ref$simplify = _ref.simplify,
					simplify =
						_ref$simplify === void 0 ? 'none' : _ref$simplify,
					_ref$transposeValue = _ref.transposeValue,
					transposeValue =
						_ref$transposeValue === void 0
							? 0
							: _ref$transposeValue,
					_ref$harmonizeAcciden = _ref.harmonizeAccidentals,
					harmonizeAccidentals =
						_ref$harmonizeAcciden === void 0
							? false
							: _ref$harmonizeAcciden,
				...
				allFilters.push.apply(
					allFilters,
					chordRendererFactory_toConsumableArray(customFilters)
				);
				return renderChord;
				/**
				...
				function renderChord(chord) {
					...
					var filteredChord = chain(
						allFilters,
						cloneDeep_default()(chord)
					);
					return printer === 'raw'
			...
			var isValidChord = function isValidChord(chord) {
				return (
					chord &&
					chordRendererFactory_typeof(chord) === 'object' &&
					!chord.error &&
					chord.input
				);
			};
			...
			/* harmony default export */ const renderer_chordRendererFactory =
				chordRendererFactory; // CONCATENATED MODULE: ./src/index.js
		})();
