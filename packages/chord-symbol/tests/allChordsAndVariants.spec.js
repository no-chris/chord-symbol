...
const allSrcSymbols = [
	...
	['C6', 'C', ['1', '3', '5', '6'], 'C6'],
	['C-6', 'C', ['1', 'b3', '5', '6'], 'Cmi6'],
	['Co7', 'C', ['1', 'b3', 'b5', 'bb7'], 'Cdim7'],
	['Cø7', 'C', ['1', 'b3', 'b5', 'b7'], 'Cmi7(b5)'],
	['C^9', 'C', ['1', '3', '5', '7', '9'], 'Cma9'],
	['C-9', 'C', ['1', 'b3', '5', 'b7', '9'], 'Cmi9'],
	['C9', 'C', ['1', '3', '5', 'b7', '9'], 'C9'],
	['C9sus', 'C', ['1', '4', '5', 'b7', '9'], 'C9sus'],
	['C^13', 'C', ['1', '3', '5', '7', '9', '13'], 'Cma13'],
	['C-11', 'C', ['1', 'b3', '5', 'b7', '9', '11'], 'Cmi11'],
	['C13', 'C', ['1', '3', '5', 'b7', '9', '13'], 'C13'],
	['C13sus', 'C', ['1', '4', '5', 'b7', '9', '13'], 'C13sus'],
	['C6/9', 'C', ['1', '3', '5', '6', '9'], 'C69'],
	['C-6/9', 'C', ['1', 'b3', '5', '6', '9'], 'Cmi69'],
	['C-^7', 'C', ['1', 'b3', '5', '7'], 'CmiMa7'],
	['C-^9', 'C', ['1', 'b3', '5', '7', '9'], 'CmiMa9'],
	['C^7#11', 'C', ['1', '3', '5', '7', '#11'], 'Cma7(#11)'],
	['C^9#11', 'C', ['1', '3', '5', '7', '9', '#11'], 'Cma9(#11)'],
	['C-b6', 'C', ['1', 'b3', '5', 'b6'], 'Cmi(add b6)'],
	['C-#5', 'C', ['1', 'b3', '#5'], 'Cmi(#5)'],
	['C^7#5', 'C', ['1', '3', '#5', '7'], 'Cma7(#5)'],
	['Cadd9', 'C', ['1', '3', '5', '9'], 'C(add9)'],
	['C-7b5', 'C', ['1', 'b3', 'b5', 'b7'], 'Cmi7(b5)'],
	['Cø9', 'C', ['1', 'b3', 'b5', 'b7', '9'], 'Cmi9(b5)'],
	['C2', 'C', ['1', '3', '5', '9'], 'C(add9)'],
	['C5', 'C', ['1', '5'], 'C5'],
	['C+', 'C', ['1', '3', '#5'], 'C+'],
	['Co', 'C', ['1', 'b3', 'b5'], 'Cdim'],
	['Cø', 'C', ['1', 'b3', 'b5', 'b7'], 'Cmi7(b5)'],
	['C7b9', 'C', ['1', '3', '5', 'b7', 'b9'], 'C7(b9)'],
	['C7#9', 'C', ['1', '3', '5', 'b7', '#9'], 'C7(#9)'],
	['C7b5', 'C', ['1', '3', 'b5', 'b7'], 'C7(b5)'],
	['C7#5', 'C', ['1', '3', '#5', 'b7'], 'C7(#5)'],
	['C7b13', 'C', ['1', '3', 'b7', 'b13'], 'C7(b13)'],
	['C7#11', 'C', ['1', '3', '5', 'b7', '#11'], 'C7(#11)'],
	['C9#11', 'C', ['1', '3', '5', 'b7', '9', '#11'], 'C9(#11)'],
	['C13#11', 'C', ['1', '3', '5', 'b7', '9', '#11', '13'], 'C13(#11)'],
	['C11', 'C', ['1', '5', 'b7', '9', '11'], 'C9sus'],
	['C7b9sus', 'C', ['1', '4', '5', 'b7', 'b9'], 'C7sus(b9)'],
	['C7b13sus', 'C', ['1', '4', 'b7', 'b13'], 'C7sus(b13)'],
	['C7add3sus', 'C', ['1', '3', '4', '5', 'b7'], 'C7sus(add3)'],
	['C9b5', 'C', ['1', '3', 'b5', 'b7', '9'], 'C9(b5)'],
	['C9#5', 'C', ['1', '3', '#5', 'b7', '9'], 'C9(#5)'],
	['C13b9', 'C', ['1', '3', '5', 'b7', 'b9', '13'], 'C13(b9)'],
	['C13#9', 'C', ['1', '3', '5', 'b7', '#9', '13'], 'C13(#9)'],
	['C7b9b13', 'C', ['1', '3', 'b7', 'b9', 'b13'], 'C7(b9,b13)'],
	['C7b9#5', 'C', ['1', '3', '#5', 'b7', 'b9'], 'C7(#5,b9)'],
	['C7b9b5', 'C', ['1', '3', 'b5', 'b7', 'b9'], 'C7(b5,b9)'],
	['C7b9#9', 'C', ['1', '3', '5', 'b7', 'b9', '#9'], 'C7(b9,#9)'],
	['C7#9#5', 'C', ['1', '3', '#5', 'b7', '#9'], 'C7(#5,#9)'],
	['C7#9b5', 'C', ['1', '3', 'b5', 'b7', '#9'], 'C7(b5,#9)'],
	['C7#9#11', 'C', ['1', '3', '5', 'b7', '#9', '#11'], 'C7(#9,#11)'],
	['C7b9#11', 'C', ['1', '3', '5', 'b7', 'b9', '#11'], 'C7(b9,#11)'],
