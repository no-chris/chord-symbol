...
function getIntervals(allModifiers$1) {
	...
	return uniq_1([
		...
		...getFifths(allModifiers$1),
		...getSixth(allModifiers$1),
		...getSevenths(allModifiers$1),
		...getNinths(allModifiers$1),
		...getElevenths(allModifiers$1),
		...getThirteenths(allModifiers$1),
	])
...
function getFifths(allModifiers$1) {
	const fifths = [];
	if (allModifiers$1.includes(allModifiers.omit5)) {
		return [];
	}
	if (hasOneOf(allModifiers$1, [allModifiers.dim, allModifiers.halfDim, allModifiers.fifthFlat])) {
		fifths.push('b5');
	}
	if (hasOneOf(allModifiers$1, [allModifiers.aug, allModifiers.fifthSharp])) {
		fifths.push('#5');
	}
...
function getNinths(allModifiers$1) {
	const ninth = [];
	if (
	...
	if (allModifiers$1.includes(allModifiers.ninthFlat)) {
		ninth.push('b9');
	}
	if (allModifiers$1.includes(allModifiers.ninthSharp)) {
		ninth.push('#9');
	}
	return ninth;
}

function getElevenths(allModifiers$1) {
	const elevenths = [];
	...
	if (allModifiers$1.includes(allModifiers.eleventhSharp)) {
		elevenths.push('#11');
	}
	return elevenths;
}

function getThirteenths(allModifiers$1) {
	const thirteenths = [];
	if (
	...
	if (allModifiers$1.includes(allModifiers.thirteenthFlat)) {
