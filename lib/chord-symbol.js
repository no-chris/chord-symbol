...
function getFifths(allModifiers, altIntervals) {
  ...
  if (hasOneOf(allModifiers, [modifiers.dim, modifiers.halfDim, modifiers.fifthFlat]) || shouldAlter(allModifiers, altIntervals.fifthFlat)) {
    fifths.push('b5');
  }

  if (hasOneOf(allModifiers, [modifiers.aug, modifiers.fifthSharp]) || shouldAlter(allModifiers, altIntervals.fifthSharp)) {
    fifths.push('#5');
  }
...
function getSixth(allModifiers) {
  ...
  if (hasOneOf(allModifiers, [modifiers.add6, modifiers.add69]) && !isExtended(allModifiers)) {
    sixth.push('6');
  }
...
function getNinths(allModifiers, altIntervals) {
  ...
  if (hasOneOf(allModifiers, [modifiers.ninthFlat]) || shouldAlter(allModifiers, altIntervals.ninthFlat)) {
    ninth.push('b9');
  }

  if (hasOneOf(allModifiers, [modifiers.ninthSharp]) || shouldAlter(allModifiers, altIntervals.ninthSharp)) {
    ninth.push('#9');
  }
...
function getElevenths(allModifiers, altIntervals) {
  ...
  if (hasOneOf(allModifiers, [modifiers.eleventhSharp]) || shouldAlter(allModifiers, altIntervals.eleventhSharp)) {
    elevenths.push('#11');
  }
...
function getThirteenths(allModifiers, altIntervals) {
  ...
  if (hasOneOf(allModifiers, [modifiers.add13, modifiers.thirteenth]) || hasOneOf(allModifiers, [modifiers.add6, modifiers.add69]) && isExtended(allModifiers)) {
    thirteenths.push('13');
  }

  if (hasOneOf(allModifiers, [modifiers.thirteenthFlat]) || shouldAlter(allModifiers, altIntervals.thirteenthFlat)) {
...
function shouldAlter(allModifiers, isDegreeAlterated) {
  return allModifiers.includes(modifiers.alt) && isDegreeAlterated;
}
...
function getIntervalsForQualityDetection(allIntervals, chord, isSuspended, omits) {
  var allFilters = [undoOmit3.bind(null, omits), undoSuspension.bind(null, isSuspended, chord.normalized.intents.major), (uniq_default())];
...
var baseTimes = __webpack_require__(2545),
    ...
    isTypedArray = __webpack_require__(4954);
