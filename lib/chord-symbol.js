...
function getChordChanges(chord) {
  ...
  return [].concat(_toConsumableArray(sortAddsAndAlterations(formattedAdds, chord.normalized.alterations)), _toConsumableArray(formattedOmits));
}
...
function sortAddsAndAlterations(adds, alterations) {
  return [].concat(_toConsumableArray(alterations), _toConsumableArray(adds)).sort(function (a, b) {
...
function parseDescriptor_iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }
...
function chordParserFactory_iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }
...
function chordParserFactory() {
  ...
  function parseChord(symbol) {
    ...
    while (allNotes.length && !chord) {
      ...
      }), parseBase.bind(null, allNotes.shift()), getParsableDescriptor, parseDescriptor.bind(null, allAltIntervals), normalizeNotes, normalizeDescriptor, formatSymbolParts, checkIntervalsConsistency, nameIndividualChordNotes].concat(chordParserFactory_toConsumableArray(customFilters));
...
function chordRendererFactory_iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }
...
/******/ 	return __webpack_require__(1739);
/******/ })()
;
});
