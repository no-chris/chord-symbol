 ...
 */
declare function chordParserFactory({ altIntervals }?: ParserConfiguration): (arg0: string) => Chord | null;
 ...
 */
declare function chordRendererFactory({ useShortNamings, simplify, transposeValue, harmonizeAccidentals, useFlats, printer, }?: RendererConfiguration): (arg0: Chord) => string;
